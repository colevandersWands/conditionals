...
{ console.log('_de-demorganed_');
const exp = (a,b,c) =>      (!a && c) && (!c && (b || c)) ;
console.log.raw(`exp: ${exp}`);
run_tests(exp, exp_cases);  }


{ console.log('_distributivity_');
const exp = (a,b,c) =>      (!a && c) && ((!c && b) || (!c && c)) ;
console.log.raw(`exp: ${exp}`);
run_tests(exp, exp_cases);  }


{ console.log('_x && !x === false_');
const exp = (a,b,c) =>      (!a && c) && ( (!c && b) || false ) ;
console.log.raw(`exp: ${exp}`);
run_tests(exp, exp_cases);  }


{ console.log('_distributing &&_');
const exp = (a,b,c) =>      !a && ( (c && (!c && b)) || (c && false ) ) ;
console.log.raw(`exp: ${exp}`);
run_tests(exp, exp_cases);  }


{ console.log('_x && false === false_');
const exp = (a,b,c) =>      !a && ( (c && (!c && b)) || false ) ;
console.log.raw(`exp: ${exp}`);
run_tests(exp, exp_cases);  }
...
{ console.log('_x && false === false_');
const exp = (a,b,c) =>      !a && ( (false && b) || false ) ;
console.log.raw(`exp: ${exp}`);
run_tests(exp, exp_cases);  }


{ console.log('_x && false === false_');
const exp = (a,b,c) =>      !a && ( false || false ) ;
console.log.raw(`exp: ${exp}`);
run_tests(exp, exp_cases);  }
